...
export const FAQS: FAQ[] = [
  ...
  },
  {
    ...
    answer: 'Los reportes están disponibles en la sección "Reportes" del menú lateral. Solo administradores y líderes tienen acceso a esta sección. Los reportes se generan basándose en los datos actuales del sistema.',
    order: 2,
    forProfiles: ['admin', 'lider'],
  },
  {
  ...
  },
  {
    ...
    answer: 'El navegante reporta el movimiento → la solicitud queda en estado "Pendiente" → un líder o administrador revisa y aprueba o rechaza → si se aprueba, la solicitud cambia a estado "Aprobada" y el material se registra bajo el nuevo responsable. Puedes ver el estado en la sección "Solicitudes".',
    order: 2,
    forProfiles: ['navegante', 'admin', 'lider'],
  },
  {
    ...
    answer: 'Si una solicitud es rechazada, verás el estado actualizado en "Solicitudes". Puedes crear una nueva solicitud reportando el movimiento nuevamente desde "Mis materiales", o contactar a tu líder para discutir el motivo del rechazo.',
    order: 3,
    forProfiles: ['navegante', 'admin', 'lider'],
  },
  {
    ...
    answer: 'Las solicitudes se encuentran en la sección "Solicitudes" del menú lateral. Los navegantes ven las solicitudes que han creado. Los líderes y administradores ven todas las solicitudes de su equipo u organización, incluyendo las que requieren aprobación.',
    order: 4,
    forProfiles: ['navegante', 'admin', 'lider'],
  },
