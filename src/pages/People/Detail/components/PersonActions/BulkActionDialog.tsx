...
const BulkActionDialog = ({
  title, description, primaryLabel, primaryColor = 'primary',
  materialsCount, onClose, onSubmit,
    ...
    <>
      ...
      <Dialog.Footer>
        <Stack sx={{ flexDirection: 'row', justifyContent: 'flex-end', gap: 1 }}>
          <Button variant="tertiary" onClick={onClose} disabled={submitting}>Cancelar</Button>
          <Button variant="primary" color={primaryColor} onClick={handleSubmit} loading={submitting}>
            {primaryLabel}
          </Button>
        </Stack>
      </Dialog.Footer>
