...
import { getPersonById, getPersonHistory, getPersonMaterials } from '../services';

export const personKeys = {
  all: () => ['people'] as const,
  detail: (id: string) => [...personKeys.all(), 'detail', id] as const,
  materials: (nombre: string) => [...personKeys.all(), 'materials', nombre] as const,
  history: (nombre: string) => [...personKeys.all(), 'history', nombre] as const,
};
